...
func handleStoryCommand(bot *telegramBot, chatId int64) {
	const message = "Эту историю написала нейросеть ChatGPT:\n\n" +
		"Родион был талантливым разработчиком и давно искал свой проект, который был бы полезен обществу. Однажды он услышал о антоновских яблоках и решил, что это то, чем он бы занялся.\n\n" +
...
func handleTrackCommand(bot *telegramBot, chatId int64) {
	audioId := os.Getenv("TG_TRACK_FILE_ID")
